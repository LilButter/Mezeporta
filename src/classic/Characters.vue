    ...
    <div class="flex flex-col items-center mt-4 mr-[-12px] relative">
      <transition name="loading-fade">
        ...
        >
          <div class="relative h-[91px] w-[85px]">
            ...
            <img
              :src="assetUrl('/classic/progress.png')"
      ...
      >
        <img
          ...
          @click="onPrevClick"
        />
        <img v-else :src="assetUrl('/classic/btn-scroll-up-disabled.png')" draggable="false" />
      </div>
      ...
      >
        <div class="relative z-[3] top-[-20px]">
          <Character class="character character-2" :character="prevPrevCharacter" />
        </div>
      </div>
      <div
        class="absolute transition-opacity duration-200"
      ...
      >
        <div class="relative z-[4]">
          <Character class="character character-1" :character="prevCharacter" />
        </div>
      </div>
      ...
      <Character
        ...
        :show-gear-button="props.showAltButtons"
        :show-box-button="props.showAltButtons"
      ...
      >
        <div class="relative z-[4] top-[80px]">
          <Character class="character character-1" :character="nextCharacter" />
        </div>
      </div>
      <div
        class="absolute transition-opacity duration-200"
      ...
      >
        <div class="relative z-[3] top-[100px]">
          <Character class="character character-2" :character="nextNextCharacter" />
        </div>
      </div>
      ...
      >
        <img
          v-if="adjacentVisible && nextCharacter"
          :src="assetUrl('/classic/btn-scroll-down.png')"
          class="state-img h-[39px] w-[132px]"
          ...
          @click="onNextClick"
        />
        <img v-else :src="assetUrl('/classic/btn-scroll-down-disabled.png')" draggable="false" />
      </div>
    </div>
    ...
    >
      <div class="flex justify-center mt-5 gap-3 pl-4">
        <button
          ...
          @mouseenter="playHover()"
          @click="onCreateClick"
          :style="{ backgroundImage: `url('${assetUrl('/classic/btn-generic.png')}')` }"
        >
        ...
        >
          ...
          <div v-if="characterSettingsPicker" class="absolute w-[192px]">
            <div
              class="relative top-[-5px] left-[2px] border-[1px] border-white/20 bg-[#000000f0] w-full"
            >
      ...
      <div class="flex justify-center mt-3">
        <button
          class="h-[56px] w-[292px] shadow shadow-black rounded state-bg font-main text-3xl"
