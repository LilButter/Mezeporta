...
<template>
  <div
    ref="settingsRootRef"
    class="classic-settings-shell settings-shell grow mt-7 min-h-0"
  ...
  >
    ...
    <div class="settings-body grow min-h-0">
      <div
        class="settings-pane-shell grow min-h-0 !px-5 !py-4 flex flex-col gap-2 overflow-hidden overflow-x-hidden"
          ...
          >
            ...
            >
              <img
                ...
                :key="`classic-settings-info-branch-header-${icon.id}`"
                :src="icon.src"
                :alt="icon.alt"
            ...
            >
              <img
                v-for="icon in currentInfo.icons"
                :key="`classic-settings-info-branch-strip-${icon.id}`"
                :src="icon.src"
                :alt="icon.alt"
            ...
            >
              <div
                v-for="icon in currentInfo.icons"
                :key="`classic-settings-info-icon-${icon.id}`"
