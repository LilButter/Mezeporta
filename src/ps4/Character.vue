...
<template>
  <div
    class="text-black my-2 h-[143px] w-[520px] p-2 relative bg-cover bg-no-repeat bg-center"
  ...
  >
    <div
      ...
      class="ps4-card-panel-buttons"
    >
      <button
        v-if="showGearButton"
        type="button"
        class="ps4-card-panel-button"
        title="Character"
